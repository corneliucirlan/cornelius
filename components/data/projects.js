export default [
	...
	{
		type: 'personal',
		imageURL: '/images/projects/mdsm/cover.png',
		case: 'mdsm',
		title: 'MDSM',
		caption: `A jQuery | JavaScript plugin built on top of Bootstrap’s framework to create a mobile responsive menu similar to Google’s Material Design.`,
		permalink: '/mdsm',
		classes: [ 'col-12', 'col-md-6', 'card' ],
		source: null,
		role: [
		...
		behanceURL: 'https://mdsm.corneliucirlan.com',
		target: '_blank',
		images: [
			// '1.webp',
			// '2.webp',
