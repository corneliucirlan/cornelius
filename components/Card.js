...
const removeElements = (string, element = 'tags') => {

	// String is null
	if ((string === null) || (string === '') || (string === undefined))
		return false

	// Regular expression to identify the elements to be removed from the input string.
	return element === 'hashtags' ? string.replace(/\#[0-9a-zA-Z]+/ig, '') : string.replace(/(<([^>]+)>)/ig, '')
}
