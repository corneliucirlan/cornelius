...
const websiteTitle: string = `Corneliu Cîrlan - Freelance Web & Mobile Designer`
const indexMetaDescription: string = `I believe that everyone has the potential to achieve great things, and I am dedicated to helping them reach their goals and dreams.`

const aboutTitle: string = `About ${separator} ${websiteTitle}`
const aboutDescription: string = `My love for computers and programming led me to UI design where I create user-friendly interfaces.`

const contactTitle: string = `Contact ${separator} ${websiteTitle}`
const contactDescription: string = `If you have a project, please let me know. I'm happy to help with any project, no matter the size. And if you just want to say hi, feel free! Thank you for considering me.`
